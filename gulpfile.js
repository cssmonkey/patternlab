...
******************************************************/
gulp.task('pl-webpack-stream', (done) => {
...
gulp.task('pl-copy:js', function(){
  return gulp.src('site.js', {cwd: resolvePath(paths().source.js)} )
...
gulp.task('pl-sass', function(){
  return gulp
    .src(paths().source.root + '/css/dev/site.scss')
...
function watch() {
  gulp.watch(resolvePath(paths().source.js + '/dev', '**/*.js')).on('change', gulp.series('pl-webpack-stream'));
  gulp.watch(resolvePath(paths().source.js, 'site.js')).on('change', gulp.series('pl-copy:js', reload));
...
gulp.task('patternlab:watch', gulp.series('patternlab:build', 'pl-webpack-stream', watch));
gulp.task('patternlab:serve', gulp.series('patternlab:build', 'pl-webpack-stream', 'patternlab:connect', watch));

gulp.task('publish-copy:js', function() {
  return gulp.src('**/*.js',{cwd: resolvePath(paths().source.js + '/dev')})
    .pipe(gulp.dest(resolvePath(paths().dist.js)));
});

gulp.task('publish-copy:scss', function() {
  return gulp.src('**/*.scss',{cwd: resolvePath(paths().source.css + '/dev')})
    .pipe(gulp.dest(resolvePath(paths().dist.css)));
});

gulp.task('patternlab:publish', gulp.series('publish-copy:js', 'publish-copy:scss', function(done) {
  done();
}));
